...
\title{Peer-Isolated Recommendation: When Content-Only Personalization Beats Collaborative Signal, and When It Doesn't}
...
\textbf{Implementation.} Embeddings via \texttt{sentence-transformers} (\texttt{all-MiniLM-L6-v2})~\cite{reimers2019,wang2020}, 384 dimensions. $K$-means via scikit-learn. All ranking ties are broken deterministically. MIND/ComiRec are trained per dataset.
...
\item {\bf Open access to data and code}
    ...
    \item[] Justification: No code or data link is included in this anonymized submission to avoid deanonymization (the repository URL directly identifies the author). Datasets used are the public Last.fm-1K~\citep{celma2010}, Amazon Reviews 2023 Books 5-core~\citep{hou2024}, and MovieLens-25M sets; code will be released upon deanonymization.
