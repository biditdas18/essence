...
\item {\bf Broader impacts}
    ...
    \item[] Justification: The paper discusses deployment settings where Essence remains viable because it consults no cross-user interaction data (Section~\ref{sec:discussion}, Appendix~\ref{app:discussion}) but does not include a dedicated broader-impacts analysis of positive and negative societal effects; this is a gap given the page-limited format.
